...
class PaketDetailPage extends StatefulWidget {
  ...
  PaketDetailPage({Key key, @required this.hasil}) : super(key: key);
...
/*
                            ...
                            Container(
                              ...
                              child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    try {
                                      if (jmlPaketController.text == "" ||
                                          int.parse(jmlPaketController.text) ==
                                              0) {
                                        Scaffold.of(context)
