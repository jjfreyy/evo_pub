...
class PaketDetailCubit extends Cubit<String> {
  PaketDetailCubit(this.kodePaket) : super("init");
  ...
  void changeJumlahPaket() {
    _changeState("changeJumlahPaket");
    _changeState("idle");
  }
  ...
  Future<void> init() async {
    ...
    try {
      ...
      if (response.statusCode != 200)
        throw new Exception("Fetch Paket Detail Error!");

      paketDetailList =
          PaketDetail.fromJsonList(jsonDecode(response.body)["data"]);
      tecQtys = [];
      paketDetailList.forEach((_) {
  ...
  Future<void> saveCart() async {
    ...
    try {
      ...
      if (response.statusCode == 500)
        throw Exception("Put Paket Detail Error!");
...
class PaketDetail {
  ...
  PaketDetail.fromJson(Map<String, dynamic> json)
